    ...
    <div class="container">   <!--Caixa inteira...-->
        ...
        <div class="Formulario">
            ...
            <form class="form3">
                    ...
                    <input class="box1" type="text" id="nome projeto" name="nome projeto" required>
                    </div>                  
                   
                    <div>
                        <label>Resumo do projeto</label>                                        
                        <input class="box2" type="text" id="resumo projeto" name="resumo projeto" required>
                    </div>
                    ...
                    <div>
                        <input class="butao" type="submit" value="Enviar" onclick="validarproj()">
                    </div>
            </form>     
